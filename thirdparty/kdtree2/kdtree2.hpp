...
namespace kdtree2 {
    typedef masb::PointList KDTreeArray;
    ...
    public:
        ...
        void n_nearest_brute_force(masb::Point& qv, int nn, KDTreeResultVector& result);
        // search for n nearest to a given query vector 'qv' usin
        // exhaustive slow search.  For debugging, usually.
        
        void n_nearest(masb::Point& qv, int nn, KDTreeResultVector& result);
        ...
        void r_nearest(masb::Point& qv, float r2,KDTreeResultVector& result);
        ...
        int r_count(masb::Point& qv, float r2);
